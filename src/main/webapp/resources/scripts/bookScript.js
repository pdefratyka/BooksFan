...
app.controller('defaultCtrl', function($scope){
  ...
  $scope.bookList=[
    {title:"First", author:"FirstAuthor", year:"1923", img:"http://images.amazon.com/images/P/0195153448.01.MZZZZZZZ.jpg", id:"1"}
  ];

  $scope.addBook = function(bookTitle, bookAuthor, bookYear, bookImg,bookId) {
  					this.bookList.push({
  						title : bookTitle,
  						author : bookAuthor,
  						year : bookYear,
